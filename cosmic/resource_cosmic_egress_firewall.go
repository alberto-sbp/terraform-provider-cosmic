...
func resourceCosmicEgressFirewall() *schema.Resource {
	return &schema.Resource{
		Create: resourceCosmicEgressFirewallCreate,
...
func resourceCosmicEgressFirewallCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if nrs := d.Get("rule").(*schema.Set); nrs.Len() > 0 {
		...
		rules := resourceCosmicEgressFirewall().Schema["rule"].ZeroValue().(*schema.Set)
	...
	return resourceCosmicEgressFirewallRead(d, meta)
}
...
func resourceCosmicEgressFirewallRead(d *schema.ResourceData, meta interface{}) error {
	cs := meta.(*cosmic.CosmicClient)
	...
	ruleMap := make(map[string]*cosmic.EgressFirewallRule, l.Count)
...
func resourceCosmicEgressFirewallUpdate(d *schema.ResourceData, meta interface{}) error {
	// Make sure all required parameters are there
	if err := verifyEgressFirewallParams(d); err != nil {
		return err
	}
...
func resourceCosmicEgressFirewallDelete(d *schema.ResourceData, meta interface{}) error {
